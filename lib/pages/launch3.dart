...
class Launch3Page extends StatelessWidget {
  const Launch3Page({super.key});
          ...
          child: Column(
            children: [
                ...
                child: Padding(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (ctx, err, trace) => const Center(
                      child: Icon(Icons.group_outlined, size: 120, color: Colors.white54),
                    ),
                  ),
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    _DotIndicator(current: 2),
                    const SizedBox(height: 24),
                    Row(
                      children: [
                        Expanded(
                          child: _OutlineButton(label: 'Sebelumnya', onTap: () => context.go('/launch2')),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: _FilledButton(label: 'Mulai Sekarang', onTap: () => _startNow(context)),
                        ),
                      ],
                    ),
                  ],
